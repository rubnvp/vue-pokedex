...
var app = new Vue({
    el: '#app',
    // usually you define data as a function that returns an object
    // in order to avoid have the same data if you have more than one instance
    data: {
        searchText: '',
        TYPE_COLOR: {
            "grass": "#78C850",
            ...
            return this.pokemons
                ...
                .filter(function(pokemon) { // filter by pokemon type (checkboxes)
                    ...
                    return pokemon.types
                        .find(function(type){ // for each pokemon type we try to find if it's included in the array selectedPokemonTypes 
    ...
    created: function(){ // function executed just after setting the reactivity https://vuejs.org/v2/guide/instance.html#Lifecycle-Diagram
        ...
        // you also have the pokemon json info in data/pokemons.json but you will need a simple local server to serve it
